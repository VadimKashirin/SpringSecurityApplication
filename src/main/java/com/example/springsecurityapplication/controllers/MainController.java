...
//    }
    ...
    public String order(){
        ...
        for(Product product : productList){
            com.example.springsecurityapplication.models.Order newOrder = new com.example.springsecurityapplication.models.Order(uuid, product, personDetails.getPerson(), 1, product.getPrice(), Status.Оформлен);
    ...
    public String orderUser(Model model){
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        PersonDetails personDetails = (PersonDetails) authentication.getPrincipal();
        List<com.example.springsecurityapplication.models.Order> orderList = orderRepository.findByPerson(personDetails.getPerson());
